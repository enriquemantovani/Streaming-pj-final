            ...
            <div className="flex flex-col gap-20 bg-blue-500">
                ...
                <section className="bg-blue-700 py-20">
                    <div className="flex flex-col items-center gap-6 container mx-auto">
                        <h1 className="text-4xl text-white font-bold">Descubra todos os seus favoritos em um piscar de olhos!</h1>
                        <p className="text-xl text-white"> Aproveite de uma seleção variada de títulos para escolher! </p>
                    </div>
                </section>
                    ...
                    <div className="w-full">
                        <div className="flex justify-between">
                            <div className="flex gap-8">
                                <button className="bg-green-400 text-xl font-bold border border-black hover:bg-green-600 transition duration-400">
                                    Criar serie
                                </button>
                                <button className="bg-green-400 text-xl font-bold border border-black hover:bg-green-600 transition duration-400">
                                    Listar todos
