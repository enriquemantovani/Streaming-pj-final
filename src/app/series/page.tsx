...
export default function SeriesPage() {
  ...
  return (
    <main className="flex-grow p-6">
      <div className="flex flex-col gap-8 bg-blue-500 rounded-xl p-8">
        <section className="text-center text-white">
          <h2 className="text-4xl font-bold">Descubra todos os seus favoritos em um piscar de olhos!</h2>
          <p className="text-xl">Aproveite de uma seleção variada de títulos para escolher!</p>
        </section>
        ...
        >
          ...
          <input
            ...
            className="w-full border p-2 mb-4 text-blue-200"
          />
